    ...
    public partial class PlayerBoard : Form
    {
        ...
        public void MovePlayer(string card)
        {
            ...
            if (lblLabel1.Location == new Point(this.playBoard.LocationsX[5], this.playBoard.LocationsY[5]))
            {
                ...
                this.lblLabel1.Location = new Point(this.PlayBoard.LocationsX[59], this.PlayBoard.LocationsY[59]);
            }

            // Move player ahead if the player is on the Rainbow bridge start square.
            if (lblLabel1.Location == new Point(this.playBoard.LocationsX[35], this.playBoard.LocationsY[35]))
            {
                // Gumdrop bridge beggins on location 35 and ends on location 45
                this.lblLabel1.Location = new Point(this.playBoard.LocationsX[45], this.playBoard.LocationsY[45]);
            }
        }
